...
// ------------ ATTRACTION ITEMS ----------------------------------------------------------------------------------------------------------------------------------------------------------------- //
	...
	// attractionItems[NUM] = "category | location | cost | tags | attraction_name | attraction_photo | attraction_link | description";

	attractionItems[0] = "Amusement-Park | Highland | $$$ | Popular,Unique | Globe-City Resort Highland | https://gcparksandresorts.github.io/gcresorthighland/webresources/images/tts-entrance.jpg | attractions/globe-city-resort-highland | A popular resort with two hotels, a theme-parl, and shopping center";
	attractionItems[1] = "Resort-Hotel | Oceanside | $$$ | Popular,Beach-Access | Globe-City's Oceanside Resort | https://www.oceanskyresort.com/files/1840/DJI_0063.jpg | attractions/globe-city-oceanside-resort | A beach front resort featuring a small amusement park";
	attractionItems[2] = "Attractions | Downtown | Free | Scenic,Unique,Free,Quiet | Sunvalley Bridge | https://www.indianriverbridge.com/wp-content/uploads/image.png | attractions/sunvalley-bridge | A scenic overlook crossing the Riverwood valley";
	...
	attractionItems[8] = "Shopping | Downtown | $$ | Local-Hotspot,Social,MDA-Accessible,Transit-Accessible | Quarts Center-City Mall | https://lamag.com/.image/t_share/MTk3NTU2MDc1OTEzNTUzNjAy/retail-district-level-2.jpg | attraction_link | An enormous shopping, dining, entertainment, and more complex in the heart of downtown";
